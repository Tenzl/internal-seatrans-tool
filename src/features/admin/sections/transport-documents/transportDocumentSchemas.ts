...
const portId = z.number().int().positive().nullable().optional()
...
export const arrivalNoticeSchema = z.object({
  ...
  placeOfReceiptPortId: portId,
  portOfLoading: shortText,
  portOfLoadingPortId: portId,
  portOfDischarge: shortText,
  portOfDischargePortId: portId,
  placeOfDelivery: shortText,
  placeOfDeliveryPortId: portId,
  finalDestination: shortText,
  finalDestinationPortId: portId,
...
export const bookingConfirmationSchema = z.object({
  ...
  placeOfIssuePortId: portId,
  pickupDate: shortText,
  pickupPlace: shortText,
  pickupPlacePortId: portId,
  portOfDischarge: shortText,
  portOfDischargePortId: portId,
  placeOfDelivery: shortText,
  placeOfDeliveryPortId: portId,
  dropoffPlace: shortText,
  dropoffPlacePortId: portId,
...
export const emptyBookingConfirmation = (): BookingConfirmationPayload => ({
  ...
  portOfLoadingPortId: null,
  placeOfIssue: '',
  placeOfIssuePortId: null,
  pickupDate: '',
  pickupPlace: '',
  pickupPlacePortId: null,
  portOfDischarge: '',
  portOfDischargePortId: null,
  placeOfDelivery: '',
  placeOfDeliveryPortId: null,
  dropoffPlace: '',
  dropoffPlacePortId: null,
  closingTime: '',
  siCutoff: '',
  vgmCutoff: '',
  contact: '',
