import type { InquiryFieldChangeLogEntry } from '@/modules/inquiries/types/shippingAgencyEpda'

export type { InquiryFieldChangeLogEntry } from '@/modules/inquiries/types/shippingAgencyEpda'
