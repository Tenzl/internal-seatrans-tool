...
export function Search({
  ...
  return (
    <Button
      ...
      variant='outline'
      className={cn(
        'group relative h-11 min-h-11 w-full flex-1 justify-start rounded-md bg-muted/25 text-sm font-normal text-muted-foreground shadow-none hover:bg-accent active:scale-[0.98] sm:pe-12 md:h-8 md:min-h-8 md:w-40 md:flex-none lg:w-52 xl:w-64',
        className
      )}
