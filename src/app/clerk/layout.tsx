        ...
        <div className='max-w-2xl'>
          <Alert>
            ...
            <AlertDescription>
              <p className='text-balance'>
                ...
                inside the <code className={codeBlock}>.env.local</code> file.
              </p>
            </AlertDescription>
          </Alert>
          ...
          <div className='mt-4 flex flex-col gap-y-4 text-foreground/75'>
            <ol className='list-inside list-decimal space-y-1.5'>
              ...
              <li>
                Add it to your <code className={codeBlock}>.env.local</code>{' '}
                file.
              </li>
            </ol>
            ...
            <div className='@container space-y-2 rounded-md bg-slate-800 px-3 py-3 text-sm text-slate-200'>
              <span className='ps-1'>.env.local</span>
          ...
          <Alert>
            ...
            <AlertDescription>
              <p className='text-balance'>
                ...
                <code className={codeBlock}>src/app/clerk</code>. If you don't
                plan to use Clerk, you can safely remove this directory and the{' '}
                <code className={codeBlock}>@clerk/nextjs</code> dependency.
              </p>
            </AlertDescription>
          </Alert>
        </div>
